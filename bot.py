...
BOT_TOKEN = os.environ.get("8824684053:AAFOMNzYK3SWo05vLpOt77gHzQbIIy8xV_o")
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "Я предсказываю стоимость дома в Бостоне.\n"
        "Использую *Random Forest* (R² = 0.89)\n\n"
        "🔹 Введи /predict для прогноза\n"
        "🔹 Введи /accuracy для точности модели",
        parse_mode='Markdown'
    )
